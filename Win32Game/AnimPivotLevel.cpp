...
void AnimPivotLevel::SwapPosition() {
...
RestrictionManager* AnimPivotLevel::GetRestrictionManager() const {
  return pRestrictionManager_;
}

void AnimPivotLevel::Tick(unsigned long long deltaTick) {
  SwapPosition();
...
CameraTarget* AnimPivotLevel::GetCameraTarget() const {
  return pCamera_;
}

ScreenMask* AnimPivotLevel::GetBackGroundMask() const {
  return pBackGroundMask_;
}

float AnimPivotLevel::GetLevelLeftBoundary() const {
  return levelLeftBoundary_;
}

float AnimPivotLevel::GetLevelRightBoundary() const {
  return levelRightBoundary_;
}

float AnimPivotLevel::GetScreenBoundaryWidth() const {
  return screenBoundaryWidth_;
}

void AnimPivotLevel::InitReadyGame() {
...
void AnimPivotLevel::ReadyGame(unsigned long long deltaTick) {
...
void AnimPivotLevel::InitInProgressGame() {
  acuumDeltaTick_ = 0;
  ...
  pBackGroundMask_->FadeOut(IMGTYPE_BlackBoardImage, 50);
  //gameStatus_ = GAMESTATUS_GameInProgress;
}

void AnimPivotLevel::InProgressGame(unsigned long long deltaTick) {
}

void AnimPivotLevel::InitEndGame() {
  acuumDeltaTick_ = 0;
...
void AnimPivotLevel::EndGame(unsigned long long deltaTick) {
  acuumDeltaTick_ += deltaTick;
