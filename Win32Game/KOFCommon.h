...
enum PLAYER_ANIM_TYPE : unsigned long long {
  ...
  PLAYER_ANIMTYPE_JumpUp,
  PLAYER_ANIMTYPE_JumpDown,
  PLAYER_ANIMTYPE_JumpLand,
  ...
  PLAYER_ANIMTYPE_Hit_High,
  PLAYER_ANIMTYPE_Hit_Low,
  PLAYER_ANIMTYPE_Hit_Strong,
  PLAYER_ANIMTYPE_Hit_AirborneUp,
  PLAYER_ANIMTYPE_Hit_AirborneDown,
  PLAYER_ANIMTYPE_Hit_AirborneLand,
  PLAYER_ANIMTYPE_Hit_AirborneGetUp,
  PLAYER_ANIMTYPE_Hit_Seat,
  PLAYER_ANIMTYPE_Hit_JumpUp,
  PLAYER_ANIMTYPE_Hit_JumpDown,
  //PLAYER_ANIMTYPE_GetUp,
  //PLAYER_ANIMTYPE_Grabbed,
