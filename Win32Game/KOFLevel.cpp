...
void KOFLevel::BeginPlay() {
  ...
  // MOUSE
  pMouse_ = SpawnMouse();
  pMouse_->SetImage(ImgManager::GetIntance()->GetImg(1));
  ...
  healthPlayer1->Initialize(pPlayer1_, 6, 0, Color8Bit(0, 0, 0, 0), {490.0f, 102.0f}, false);
  ...
  healthPlayer2->Initialize(pPlayer2_, -6, 0, Color8Bit(0, 0, 0, 0), {1415.0f, 102.0f}, true);
