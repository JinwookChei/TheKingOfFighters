...
ToolLevel::ToolLevel()
  ...
  IFileImage* healthHUDImage = ImgManager::GetIntance()->LoadImg("..\\ContentsResource\\KOFImages\\HUD_Health_Box.png", 1);
  healthHUDImage->CalculateTransformFromDrawBoxImage(Color8Bit{0, 0, 0, 0}, Color8Bit::Magenta);
  const std::string& readFilePath("..\\ContentsResource\\CSV\\HealthHUD.csv");
  const std::string& writeFilePath("..\\ContentsResource\\CSV\\HealthHUD_new.csv");
