...
void Iori::Initialize(bool isPlayer1, const Vector& position, bool useCameraPosition, KOFPlayer* opponentPlayer) {
  ...
  // ANIM
  CallCreateAnimation(PLAYER_ANIMTYPE_StartPos, IMGTYPE_ChangImage, 0, 15, ANIMINTERVAL, true, 7);
  CallCreateAnimation(PLAYER_ANIMTYPE_Idle, IMGTYPE_ChangImage, 7, 15, ANIMINTERVAL, true, 7);
  CallCreateAnimation(PLAYER_ANIMTYPE_SeatDown, IMGTYPE_ChangImage, 16, 17, ANIMINTERVAL, false, 16);
  CallCreateAnimation(PLAYER_ANIMTYPE_Seat, IMGTYPE_ChangImage, 18, 23, ANIMINTERVAL, true, 18);
  CallCreateAnimation(PLAYER_ANIMTYPE_SeatUp, IMGTYPE_ChangImage, 24, 25, ANIMINTERVAL, false, 24);
  CallCreateAnimation(PLAYER_ANIMTYPE_FrontWalk, IMGTYPE_ChangImage, 27, 34, ANIMINTERVAL, true, 27);
  CallCreateAnimation(PLAYER_ANIMTYPE_BackWalk, IMGTYPE_ChangImage, 35, 44, ANIMINTERVAL, true, 35);
  CallCreateAnimation(PLAYER_ANIMTYPE_BackStep, IMGTYPE_ChangImage, 45, 48, ANIMINTERVAL, false, 45);
  CallCreateAnimation(PLAYER_ANIMTYPE_Run, IMGTYPE_ChangImage, 49, 57, ANIMINTERVAL, true, 51);
  CallCreateAnimation(PLAYER_ANIMTYPE_RunEnd, IMGTYPE_ChangImage, 58, 60, ANIMINTERVAL, false, 59);
  CallCreateAnimation(PLAYER_ANIMTYPE_JumpUp, IMGTYPE_ChangImage, 61, 65, ANIMINTERVAL, false, 61);
  CallCreateAnimation(PLAYER_ANIMTYPE_JumpDown, IMGTYPE_ChangImage, 66, 68, ANIMINTERVAL, false, 66);
  CallCreateAnimation(PLAYER_ANIMTYPE_JumpLand, IMGTYPE_ChangImage, 69, 69, ANIMINTERVAL, false, 69);
  CallCreateAnimation(PLAYER_ANIMTYPE_Dash, IMGTYPE_ChangImage, 70, 77, ANIMINTERVAL, false, 70);
  CallCreateAnimation(PLAYER_ANIMTYPE_RollingBack, IMGTYPE_ChangImage, 78, 87, ANIMINTERVAL, false, 78);
  CallCreateAnimation(PLAYER_ANIMTYPE_Guard, IMGTYPE_ChangImage, 541, 541, ANIMINTERVAL, false, 541);
  CallCreateAnimation(PLAYER_ANIMTYPE_GuardEnd, IMGTYPE_ChangImage, 542, 543, ANIMINTERVAL, false, 542);
  CallCreateAnimation(PLAYER_ANIMTYPE_Guard_Seat, IMGTYPE_ChangImage, 548, 548, ANIMINTERVAL, false, 548);
  CallCreateAnimation(PLAYER_ANIMTYPE_GuardEnd_Seat, IMGTYPE_ChangImage, 549, 549, ANIMINTERVAL, false, 549);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyKick_CloseRange, IMGTYPE_ChangImage, 136, 144, ANIMINTERVAL, false, 136);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightKick_CloseRange, IMGTYPE_ChangImage, 123, 127, ANIMINTERVAL, false, 123);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyPunch_CloseRange, IMGTYPE_ChangImage, 128, 135, ANIMINTERVAL, false, 128);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightPunch_CloseRange, IMGTYPE_ChangImage, 118, 122, ANIMINTERVAL, false, 118);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyKick_LongRange, IMGTYPE_ChangImage, 108, 117, ANIMINTERVAL, false, 108);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightKick_LongRange, IMGTYPE_ChangImage, 94, 98, ANIMINTERVAL, false, 94);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyPunch_LongRange, IMGTYPE_ChangImage, 99, 107, ANIMINTERVAL, false, 99);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightPunch_LongRange, IMGTYPE_ChangImage, 88, 93, ANIMINTERVAL, false, 88);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyKick_Seat, IMGTYPE_ChangImage, 181, 191, ANIMINTERVAL, false, 181);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightKick_Seat, IMGTYPE_ChangImage, 165, 171, ANIMINTERVAL, false, 165);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyPunch_Seat, IMGTYPE_ChangImage, 172, 180, ANIMINTERVAL, false, 172);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightPunch_Seat, IMGTYPE_ChangImage, 192, 197, ANIMINTERVAL, false, 192);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyKick_Jump, IMGTYPE_ChangImage, 213, 218, ANIMINTERVAL, false, 213);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightKick_Jump, IMGTYPE_ChangImage, {204, 204, 205, 205}, ANIMINTERVAL, false, 204);
  CallCreateAnimation(PLAYER_ANIMTYPE_HeavyPunch_Jump, IMGTYPE_ChangImage, 206, 212, ANIMINTERVAL, false, 206);
  CallCreateAnimation(PLAYER_ANIMTYPE_LightPunch_Jump, IMGTYPE_ChangImage, 198, 203, ANIMINTERVAL, false, 198);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_High, IMGTYPE_ChangImage, 557, 562, ANIMINTERVAL, false, 557);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_Low, IMGTYPE_ChangImage, 563, 567, ANIMINTERVAL, false, 563);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_Strong, IMGTYPE_ChangImage, 594, 607, ANIMINTERVAL, false, 594);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_AirborneUp, IMGTYPE_ChangImage, 594, 597, ANIMINTERVAL, false, 594);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_AirborneDown, IMGTYPE_ChangImage, 608, 608, ANIMINTERVAL, false, 608);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_AirborneLand, IMGTYPE_ChangImage, {609, 610, 611, 611, 611, 611, 611, 611}, ANIMINTERVAL, false, 609);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_AirborneGetUp, IMGTYPE_ChangImage, 612, 615, ANIMINTERVAL, false, 612);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_Seat, IMGTYPE_ChangImage, 552, 556, ANIMINTERVAL, false, 552);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_JumpUp, IMGTYPE_ChangImage, {594, 595}, 80, false, 595);
  CallCreateAnimation(PLAYER_ANIMTYPE_Hit_JumpDown, IMGTYPE_ChangImage, 80, 85, ANIMINTERVAL, false, 82);
  CallCreateAnimation(PLAYER_ANIMTYPE_NeckGrabbed, IMGTYPE_ChangImage, 572, 575, 150, false, 572);
  CallCreateAnimation(PLAYER_ANIMTYPE_KOKnockBackUp, IMGTYPE_ChangImage, 594, 597, ANIMINTERVAL, false, 594);
  CallCreateAnimation(PLAYER_ANIMTYPE_KOKnockBackDown, IMGTYPE_ChangImage, 608, 610, ANIMINTERVAL, false, 608);
  CallCreateAnimation(PLAYER_ANIMTYPE_KOKnockBackLand, IMGTYPE_ChangImage, {611}, ANIMINTERVAL, true, 611);
  ...
  CallCreateAnimation(IORI_ANIMTYPE_1211ShikiYaOtome_0, IMGTYPE_ChangImage, 344, 347, 70, false, 344);
