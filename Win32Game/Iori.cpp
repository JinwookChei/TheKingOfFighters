...
void Iori::Initialize(const Vector& position, bool useCameraPosition, KOFPlayer* opponentPlayer) {
  ...
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_Jump, PS_Jump, true, true);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_HeavyKick, PS_Attack, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_LightKick, PS_Attack, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_HeavyPunch, PS_Attack, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_LightPunch, PS_Attack, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_HeavyKick_Seat, PS_Seat, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_LightKick_Seat, PS_Seat, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_HeavyPunch_Seat, PS_Seat, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_LightPunch_Seat, PS_Seat, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_HeavyKick_Jump, PS_Attack, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_LightKick_Jump, PS_Attack, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_HeavyPunch_Jump, PS_Attack, false, false);
  pStateComponent_->RegistState(PLAYER_ANIMTYPE_LightPunch_Jump, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_108ShikiYamiBarai, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_GaishikiMutan_1, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_GaishikiMutan_2, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_Shinigami, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_HyakushikiOniyaki, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_127ShikiAoiHana_1, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_127ShikiAoiHana_2, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_127ShikiAoiHana_3, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_UltimateCasting, PS_None, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_1, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_2, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_3, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_4, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_5, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_6, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_7, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_8, PS_Attack, false, false);
  pStateComponent_->RegistState(IORI_ANIMTYPE_1211ShikiYaOtome_9, PS_Attack, false, false);
...
void Iori::CompareInputBitset() {
  if (true == IsEqualInputBitSet(inputPressBitSet_, std::bitset<8>("00000000")) &&
      ...
      PS_Jump != pStateComponent_->GetPlayerState()) {
  } else {
    switch (pStateComponent_->GetPlayerState()) {
      case PS_Jump: {
        // A | PRESS
